package com.deliverytech.delivery_api.common.monitoring.alerts;
...
public class AlertService {
  ...
  private void enviarAlerta(String po, String mensagem, String severidade) {
    ...
    // Log do alerta
    logger.warn("ALERTA [{}] {}: {}", severidade, po, mensagem);
