package com.deliverytech.delivery_api.pedido.controller;
...
public class PedidoController {
  ...
  public ResponseEntity<ApiResponseWrapper<PedidoResponseDTO>> atualizarStatus(
      ...
      @Valid @RequestBody PedidoStatusDTO statusDTO) {
  ...
  public ResponseEntity<ApiResponseWrapper<BigDecimal>> calcularTotal(@Valid @RequestBody List<PedidoItemDTO> itens) {
